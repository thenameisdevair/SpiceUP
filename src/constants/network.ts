 ...
 * Supports Sepolia (testnet) and Mainnet switching via env var
 */
...
/**
 * Current network config based on NEXT_PUBLIC_NETWORK env var.
 * Defaults to Sepolia for development.
 */
export const NETWORK: NetworkConfig =
  (process.env.NEXT_PUBLIC_NETWORK as "sepolia" | "mainnet") === "mainnet"
    ? MAINNET
    : SEPOLIA;
